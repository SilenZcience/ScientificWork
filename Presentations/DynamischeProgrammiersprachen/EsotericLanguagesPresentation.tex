...
% Landin forderte eine systematische, kartierbare Sprachgestaltung; Esolangs stehen dem entgegen, da sie bewusst individuell und aufwendig konstruiert sind.


% Arbeiten zu Sprach-Langlebigkeit und Erfolg (z. B. Chatley et al., Mashey) lassen sich kaum auf Esolangs anwenden, obwohl viele von ihnen lange existieren.


% In der PL-Forschung (Onward!, HOPL) wird die Natur von Programmiersprachen breit diskutiert, wobei Esolangs immer wieder als Kontrastfall dienen.


% Steele und Gabriel nehmen Esolangs ernst und präsentieren sie neben Mainstream-Sprachen, was ihre konzeptionelle Relevanz unterstreicht.


% Nach McIver verstoßen Esolangs gegen alle Designprinzipien für lernfreundliche Sprachen („sieben Todsünden“).


% Soziologische Studien sehen Esolangs als Ausdruckskultur, verwandt mit IOCCC, die Persönlichkeit, Spiel und Regelbruch betont.


% Esolangs priorisieren persönliche Expression und ästhetisches Experimentieren über Praktikabilität und Verständlichkeit.


% Es bestehen Parallelen zwischen Esolangs und konstruierten natürlichen Sprachen (z. B. Esperanto, Elvish).
