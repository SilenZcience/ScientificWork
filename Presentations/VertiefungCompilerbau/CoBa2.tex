...
\definecolor{rustOrange}{RGB}{247, 140, 108}
\definecolor{rustComment}{RGB}{128, 128, 128}
\definecolor{rustLib}{RGB}{224, 180, 97}
...
\begin{frame}[fragile]{DWARF Debug-Information Beispiel}
  \begin{lstlisting}[language=C,basicstyle=\ttfamily\tiny,escapechar=\#]
DW_TAG_compile_unit // Kompilierungseinheit-Metadaten (``Wurzelknoten'')
  DW_AT_producer ("clang ver 7.0.1")
  DW_AT_language (DW_LANG_C99)
  DW_AT_name ("a.c")
  DW_AT_low_pc (#\textcolor{rustOrange}{0x00400480}#) // Startadresse der Funktion
  DW_AT_high_pc (<offset-from-lowpc>#\textcolor{rustOrange}{50}#) // Endadresse der Funktion

DW_TAG_subprogram // Funktionsinformationen
  DW_AT_name ("main")
  DW_AT_decl_line (#\textcolor{rustOrange}{2}#)
  DW_AT_frame_base (DW_OP_reg6 RBP)

DW_TAG_variable // Variableninformationen
  DW_AT_name ("a")
  DW_AT_location (DW_OP_fbreg -#\textcolor{rustOrange}{8}#) // Offset von RBP (Variablenort)
  DW_AT_decl_line (#\textcolor{rustOrange}{1}#) // Deklarationszeile im Quellcode
  DW_AT_type (#\textcolor{rustOrange}{0x00000060}# "int") // Typ-Referenz (z.B. int)

DW_TAG_variable // Variableninformationen
  DW_AT_name ("b")
  DW_AT_location (DW_OP_fbreg -#\textcolor{rustOrange}{12}#)
  DW_AT_decl_line (#\textcolor{rustOrange}{1}#)
  DW_AT_type (#\textcolor{rustOrange}{0x00000060}# "int")
  \end{lstlisting}
\end{frame}
...
\begin{frame}[fragile]{LLVM Bug 43893 (Clang-9)}
  \begin{columns}
    \column{0.55\textwidth}
      \begin{lstlisting}[language=C,firstnumber=3,basicstyle=\ttfamily\small,escapechar=\#]
int c = --a;
int l = -#\textcolor{rustOrange}{8L}#;
l = c;       // optimized out
c > (b = #\textcolor{rustOrange}{0}#); // l
      \end{lstlisting}
...
% InstCombine = Instruction Combining (z.B. algebraische Vereinfachungen, double negate ..., constant folding ...)
...
\begin{frame}[fragile]{GCC Bug 89463 (GCC-8.3)}
  \begin{columns}
    \column{0.55\textwidth}
      \begin{lstlisting}[language=C,firstnumber=3,basicstyle=\ttfamily\small,escapechar=\#]
int i;
for (; a < #\textcolor{rustOrange}{10}#; a++)
    i = #\textcolor{rustOrange}{0}#;
for (; i < #\textcolor{rustOrange}{6}#; i++)
    ;
opt_me_not(); // i
      \end{lstlisting}
...
int main() {
    unsigned c;
    --b;
    c=#\textcolor{rustOrange}{2}#;
    if (a)
        b=#\textcolor{rustOrange}{0}#;
    return #\textcolor{rustOrange}{0}#;
}
  \end{lstlisting}
...
\begin{frame}[fragile]{Shadow Validation Beispiel}
  \begin{itemize}
        \begin{lstlisting}[language=C,firstnumber=3,basicstyle=\ttfamily\tiny,escapechar=\#]
  unsigned c;
  --b;
  c=#\textcolor{rustOrange}{2}#; // c hier initialisiert
        \end{lstlisting}
...
\begin{frame}[fragile]{Fallstudie: GCC wrong value bug 92387}
  \begin{lstlisting}[language=C,basicstyle=\ttfamily\tiny,escapechar=\#]
static int a[#\textcolor{rustOrange}{6}#];
int b;
static void c() { b = #\textcolor{rustOrange}{5}# ^ a[b & #\textcolor{rustOrange}{5}#]; }
int main() {
    int i, d = #\textcolor{rustOrange}{0}#;
    c();
    i = #\textcolor{rustOrange}{0}#;
    for (; i < #\textcolor{rustOrange}{8}#; i++) {
        c();
        if(d) printf("%d",i); // i
    }
}
...
int main() {
    --b;
    unsigned l_801 = #\textcolor{rustOrange}{36901}#;
    ++l_801;
    if (a) // l_801
        b = #\textcolor{rustOrange}{0}#;
}
...
% Einfache Inkrement-Operation, Debug-Info nicht aktualisiert.
% Clang Trunk betroffen.
% Zeigt: Sogar Basis-Operationen können Bugs triggern.
...
#\textcolor{rustOrange}{fn}# #\textcolor{Blue}{main}#() {
    #\textcolor{rustOrange}{let mut}# counter = #\textcolor{rustOrange}{0}#;
    {
        #\textcolor{rustOrange}{let mut}# tick = || counter += #\textcolor{rustOrange}{1}#;
        #\textcolor{Blue}{tick}#();
        #\textcolor{Blue}{tick}#();
        #\textcolor{rustLib}{lib}#::#\textcolor{Blue}{opt\_me\_not}#();  #\textcolor{rustComment}{// counter sollte 2 sein}#
    }
    #\textcolor{Blue}{assert\_eq!}#(counter, #\textcolor{rustOrange}{2}#);
}
  \end{lstlisting}
  \begin{itemize}
...
% Framework auf Rust mit minimalen Änderungen generalisiert.
% Closure-Variable-Tracking-Bug.
% Rust Compiler verwendet LLVM-Backend, daher ähnliche Probleme.
