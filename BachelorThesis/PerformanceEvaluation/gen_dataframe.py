...
post1fno = open('time_nano1postnoop.txt', 'r', encoding='utf-8')
...
post5f = open('time_nano5post.txt', 'r', encoding='utf-8')
...
with open('output.csv', 'w', encoding='utf-8') as file:
    file.write("test_id,query_id,pre1_ns,pre2_ns,pre3_ns,pre1_fix_ns,post1_ipc_ns,post1_ipc_noop_ns,post2_ipc_ns,post3_ipc_ns,post4_ipc_ns,post5_ipc_ns,post1_tcp_ns,post2_tcp_ns,post3_tcp_ns,request_counter\n")
