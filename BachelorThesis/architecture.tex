...
Aus diesem Grund wurde das Logging-System auf der Seite des Z3-Servers selbst implementiert, um gegebenfalls die Ausgabe in einer Datei zu speichern.
...
Womöglich könnte dies auch zu Konflikten führen, wenn mehrere Prozesse gleichzeitig auf die Datei schreiben, sodass Informationen vollständig verloren gehen, oder nur ein einziger Z3-Solver die Datei beschreiben kann.
