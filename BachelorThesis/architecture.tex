...
\begin{figure}[!htp]
    ...
    \begin{tikzpicture}[scale=1, every node/.style={scale=1}]
        ...
        \draw[dashed] (4.9, 5.5) -- node[below,sloped,pos=0.63]{\tiny \textbf{Helperfunction}} (8, 5.5);
        % \node[above] at (1.1, 5.4) {\tiny \textbf{Helperfunction}};
        \draw[thick,<-] (0.5, 5.2) -- node[above,sloped,pos=0.3,yshift=-2.5]{\tiny \text{Reply}} (4.5, 5.2);
        ...
        \draw[thick,->] (0.5, 3.6) -- node[above,sloped,pos=0.7,yshift=-2.5]{\tiny \text{Request}} (4.5, 3.6);


        \draw[dashed] (0.1, 3) rectangle (4.9, 2);
        \draw[dashed] (4.9, 3) -- node[below,sloped,pos=0.63]{\tiny \textbf{Helperfunction}} (8, 3);
...
In \cref{fig:mk-type-sequence} ist ein Ausschnitt des Sequenzdiagramms von der Hilfsfunktion \texttt{mk\_type} dargestellt, welches die Komplexität der Funktion verdeutlicht
...
\begin{figure}[!htp]
  ...
  \begin{tikzpicture}[scale=3, every node/.style={scale=0.7}]
    ...
    \begin{scope}
      ...
      \node[left] at ($(a)!0.89!(b)$) {exit};
      \node[right] at ($(c)!0.87!(d)$) {exit};
      \node[left] at ($(a)!0.805!(b)$) {check prolog term};
      \node[right] at ($(c)!0.775!(d)$) {check if type exists};
      \node[left] at ($(a)!0.74!(b)$) {exit};
      \node[right] at ($(c)!0.72!(d)$) {exit};
      \node[left] at ($(a)!0.685!(b)$) {check iterable type};
      % \node[left] at ($(a)!0.56!(b)$) {exit};
      % \node[right] at ($(c)!0.54!(d)$) {exit};
      ...
      \draw[decorate, decoration={brace, amplitude=10pt}] (2.8, 3.45) -- (2.8, 1)
      ...
      \draw[thick,-stealth,blue] ($(a)!0.62!(b)$) -- node[above,sloped,midway]{\tiny set} ($(c)!0.60!(d)$);
      % \draw[thick,stealth-] ($(a)!0.57!(b)$) -- node[above,sloped,midway]{} ($(c)!0.59!(d)$);
      % \draw[thick,-stealth] ($(a)!0.56!(b)$) -- node[above,sloped,midway]{} ($(c)!0.54!(d)$);

      \draw[thick,-stealth,blue] ($(a)!0.62!(b)$) -- node[above,sloped,midway]{\tiny global atom} ($(c)!0.52!(d)$);
      ...
      \draw[thick,-stealth,blue] ($(a)!0.62!(b)$) -- node[above,sloped,midway]{\tiny couple} ($(c)!0.44!(d)$);
      ...
      \draw[thick,-stealth,blue] ($(a)!0.62!(b)$) -- node[above,sloped,midway]{\tiny record} ($(c)!0.36!(d)$);

      \draw[dashed, path fading=line fade] ($(a)!0.34!(b)$) -- node[above,sloped,midway]{} ($(c)!0.59!(d)$);
      \draw[dashed, path fading=line fade] ($(a)!0.26!(b)$) -- node[above,sloped,midway]{} ($(c)!0.51!(d)$);
      \draw[dashed, path fading=line fade] ($(a)!0.18!(b)$) -- node[above,sloped,midway]{} ($(c)!0.43!(d)$);
      \draw[dashed, path fading=line fade] ($(a)!0.10!(b)$) -- node[above,sloped,midway]{} ($(c)!0.35!(d)$);
      ...
      \node[right] at (-1,2.25) {\small falsy response};
  ...
  \end{tikzpicture}
  \caption{Ein Ausschnitt des Sequenzdiagramms von der Hilfsfunktion \texttt{mk\_type}.}
