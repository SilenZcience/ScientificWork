...
\begin{figure}[!htp]
  ...
  \end{tikzpicture}
  \caption{Das Sequenzdiagramm der Hilfsfunktion $mk\_type$. Der Übersicht halber sind nicht alle Nachrichten beschriftet. Derartige Nachrichten übermitteln zumeist ausschließlich Statusindikatoren.}
