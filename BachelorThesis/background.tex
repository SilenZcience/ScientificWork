...
Weitere Theorien wie lineare und nichtlineare Arithmetik, Bit-Vektoren und Arrays werden durch weitere Theorie-Solver behandelt,
...
Innerhalb der geplanten Architektur wird als Technologie zur Kommunikation zwischen den zwei seperaten Prozessen die ZeroMQ-Bibliothek \cite{hintjens2013zeromq} verwendet.
