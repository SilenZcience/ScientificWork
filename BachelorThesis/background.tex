...
\todo[]{Korrekte Referenzierung von Quellen überprüfen.}
...
\todo[]{hier mache ich bestimmt noch den eigentlichen algorithmus hin, weil ich prinzipiell einfach ein algorithmenverzeichnis haben möchte xD}
\begin{enumerate}
