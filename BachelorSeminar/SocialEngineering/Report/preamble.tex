...
\usepackage[bitstream-charter]{mathdesign} % better linewrap
...
\AtBeginDocument{\renewcommand{\contentsname}{INHALT}}
\AtBeginDocument{\newcommand{\replacechaptername}{Kapitel}}
\AtBeginDocument{\renewcommand{\chaptername}{\replacechaptername}}
\AtBeginDocument{\renewcommand{\bibname}{Quellenverzeichnis}}
...
\hfuzz1pt % Don't bother to report over-full boxes if over-edge is < 1pt
...
\renewcommand{\tableofcontents}{
	\chapter*{
	  ...
	  \begin{tikzpicture}[remember picture, overlay]
		  ...
		  \draw[fill=doc!60,draw=doc!60] (13.28,-.60) rectangle (20,1);
		  \clip (13.28,-.60) rectangle (20,1);
